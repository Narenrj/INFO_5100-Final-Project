...
public class JavaMailService {
    ...
    public static void send(String from, Collection<String> recipients, String subject, String text)
        ...
        send(from, recipients, subject, text,  null, null);
    }
    ...
    public static void send(String from, String recipient, String subject, String text,
            ...
            throws MessagingException, IOException {
        send(from, Arrays.asList(recipient), subject, text,  Arrays.asList(fileName),
    ...
    public static void send(String from, Collection<String> recipients, String subject, String text,
        ...
        // send the message
        String username = properties.getProperty("noreplybaymax@gmail.com");
        String password = properties.getProperty("Noreplybaymax@12");
        Transport.send(message, "noreplybaymax@gmail.com", "Noreplybaymax@12");
    }
